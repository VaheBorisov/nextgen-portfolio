  ...
  return (
    <section id="services" className="py-20 px-6">
      <div className="container mx-auto max-w-6xl">
              ...
              <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-8">
                {featured.map(service => (
                  ...
                  >
                    ...
                    <h3 className="text-xl @md/card:text-2xl font-bold mb-3">{service.title}</h3>
        ...
        {regular.length > 0 && (
          <div>
            {featured.length > 0 && <h3 className="text-2xl font-bold mb-6">All Services</h3>}
            <div className="@container">
              <div className="grid grid-cols-1 @2xl:grid-cols-2 @5xl:grid-cols-3 gap-6">
                {regular.map(service => (
                  ...
                  >
                    ...
                    <h3 className="text-lg @md/card:text-xl font-bold mb-2">{service.title}</h3>
