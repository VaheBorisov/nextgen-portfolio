...
export default function ContactForm() {
  ...
  return (
    <div className="@container/form bg-card border rounded-lg p-4 @md/form:p-6">
      <h3 className="text-xl @md/form:text-2xl font-semibold mb-6">Send a Message</h3>
      ...
      <form className="space-y-3 @md/form:space-y-4" onSubmit={handleSubmit}>
        <div>
          <label htmlFor="name" className="block text-xs @md/form:text-sm font-medium mb-2">
            Name
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="email" className="block text-xs @md/form:text-sm font-medium mb-2">
            Email
          </label>
          <input
            type="email"
        ...
        <div>
          <label htmlFor="subject" className="block text-xs @md/form:text-sm font-medium mb-2">
            Subject
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="message" className="block text-xs @md/form:text-sm font-medium mb-2">
            Message
          </label>
          <textarea
            id="message"
