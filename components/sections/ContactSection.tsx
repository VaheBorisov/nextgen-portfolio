        ...
        <div className="@container">
          <div className="grid grid-cols-1 @3xl:grid-cols-2 gap-8">
            ...
            <div className="@container/info space-y-6">
              <h3 className="text-xl @md/info:text-2xl font-semibold mb-6">Contact Information</h3>
              ...
              {profile.phone && (
                <div className="flex items-start gap-3 @md/info:gap-4">
                  ...
                  <div className="min-w-0">
                    <h4 className="font-semibold mb-1 text-sm @md/info:text-base">Phone</h4>
                    <Link
              ...
              {profile.location && (
                <div className="flex items-start gap-3 @md/info:gap-4">
                  ...
                  <div className="min-w-0">
                    <h4 className="font-semibold mb-1 text-sm @md/info:text-base">Location</h4>
