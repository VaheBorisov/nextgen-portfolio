...
export default function FloatingDockClient({ navItems }: FloatingDockClientProps) {
          ...
          {desktop.shouldShowMore && (
            <div className="relative">
              <button
                ...
                aria-label={desktopMoreMenuOpen ? 'Close more navigation items' : 'Show more navigation items'}
            ...
            {mobile.shouldShowMore && (
              <div className="relative">
                <button
                  ...
                  aria-label={mobileMoreMenuOpen ? 'Close more navigation items' : 'Show more navigation items'}
